...
Core design principles for creating distinctive, production-grade frontend interfaces that avoid generic "AI slop" aesthetics.
...
3. **Run /wf-design:setup (REQUIRED)**: If neither source has context, you MUST run `/wf-design:setup` NOW before doing anything else. Do NOT skip this step. Do NOT attempt to infer context from the codebase instead.
...
### Typography
> *Consult [typography reference](typography.md) for OpenType features, web font loading, and the deeper material on scales.*
...
### Color & Theme
> *Consult [color reference](color-and-contrast.md) for the deeper material on contrast, accessibility, and palette construction.*
...
### Layout & Space
> *Consult [spatial reference](spatial-design.md) for the deeper material on grids, container queries, and optical adjustments.*
...
### Motion
> *Consult [motion reference](motion-design.md) for timing, easing, and reduced motion.*
...
### Interaction
> *Consult [interaction reference](interaction-design.md) for forms, focus, and loading patterns.*
...
### Responsive
> *Consult [responsive reference](responsive-design.md) for mobile-first, fluid design, and container queries.*
...
### UX Writing
> *Consult [ux-writing reference](ux-writing.md) for labels, errors, and empty states.*
