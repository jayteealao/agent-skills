...
Run /wf-design, passing along whatever feature description the user provided.
...
If the user has already run /wf-design and has a confirmed design brief, skip this step and use the existing brief.
...
3. **Check against the design guidelines DON'T rules.** Fix any anti-pattern violations. See [design-guidelines.md](design-guidelines.md) for the full list.
