...
> was found wrong or stale when verified against v9.144.0 — including the taxonomy test, the doc-site regime (W5), the test wiring (W7), the contract section
> number, and the read-only tripwire's dead-end routing.
