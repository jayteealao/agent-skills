...
<tr>
  <td>Explore every distinct approach before picking one</td>
  <td><code>/wf intake investigate "question"</code></td>
  <td>Produces a single artifact sketching every distinct engineering approach found (up to 3 presented as full tradeoff cards). No winner is picked — you decide, then route to <code>/wf intake</code> or <code>/wf intake fix</code>.</td>
</tr>
<tr>
...
<tr><td><code>/wf intake investigate</code></td><td>Sketch every distinct engineering approach found, with tradeoffs, before committing to one</td><td>Single artifact; up to 3 approaches presented as full tradeoff cards; no winner picked — you choose, then route to <code>/wf intake fix</code> or <code>/wf intake</code></td></tr>
