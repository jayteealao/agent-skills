...
Use this skill when the user asks for `/review-correctness`, references `commands/review/correctness.md`, or describes the same workflow intent.
...
- ../../../commands/review/correctness.md
