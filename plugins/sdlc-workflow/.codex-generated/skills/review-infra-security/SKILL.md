...
Use this skill when the user asks for `/review-infra-security`, references `commands/review/infra-security.md`, or describes the same workflow intent.
...
- ../../../commands/review/infra-security.md
