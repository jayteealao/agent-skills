...
Use this skill when the user references `commands/review/security.md` or describes this focused workflow intent. The source declares `/review-security`, but this generated skill is named `review-security-focused` to avoid colliding with another Codex skill.
