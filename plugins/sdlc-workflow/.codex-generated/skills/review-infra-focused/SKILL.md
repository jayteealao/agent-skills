...
Use this skill when the user references `commands/review/infra.md` or describes this focused workflow intent. The source declares `/review-infra`, but this generated skill is named `review-infra-focused` to avoid colliding with another Codex skill.
