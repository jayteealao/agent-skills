...
Use this skill when the user references `commands/review/architecture.md` or describes this focused workflow intent. The source declares `/review-architecture`, but this generated skill is named `review-architecture-focused` to avoid colliding with another Codex skill.
