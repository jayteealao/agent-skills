...
Use this skill when the user asks for `/review-refactor-safety`, references `commands/review/refactor-safety.md`, or describes the same workflow intent.
...
- ../../../commands/review/refactor-safety.md
