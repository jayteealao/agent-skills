...
Use this skill when the user asks for `/setup-wide-logging`, references `commands/setup-wide-logging.md`, or describes the same workflow intent.
...
- ../../../commands/setup-wide-logging.md
