...
Use this skill when the user asks for `/review-frontend-accessibility`, references `commands/review/frontend-accessibility.md`, or describes the same workflow intent.
...
- ../../../commands/review/frontend-accessibility.md
