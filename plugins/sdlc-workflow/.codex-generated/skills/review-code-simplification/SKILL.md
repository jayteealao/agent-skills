...
Use this skill when the user asks for `/review-code-simplification`, references `commands/review/code-simplification.md`, or describes the same workflow intent.
...
- ../../../commands/review/code-simplification.md
