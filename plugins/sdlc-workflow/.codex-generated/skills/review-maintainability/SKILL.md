...
Use this skill when the user asks for `/review-maintainability`, references `commands/review/maintainability.md`, or describes the same workflow intent.
...
- ../../../commands/review/maintainability.md
