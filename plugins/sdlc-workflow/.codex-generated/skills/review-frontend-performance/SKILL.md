...
Use this skill when the user asks for `/review-frontend-performance`, references `commands/review/frontend-performance.md`, or describes the same workflow intent.
...
- ../../../commands/review/frontend-performance.md
