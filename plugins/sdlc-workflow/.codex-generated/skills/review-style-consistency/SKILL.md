...
Use this skill when the user asks for `/review-style-consistency`, references `commands/review/style-consistency.md`, or describes the same workflow intent.
...
- ../../../commands/review/style-consistency.md
