...
Use this skill when the user asks for `/review-api-contracts`, references `commands/review/api-contracts.md`, or describes the same workflow intent.
...
- ../../../commands/review/api-contracts.md
