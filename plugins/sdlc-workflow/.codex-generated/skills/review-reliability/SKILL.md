...
Use this skill when the user asks for `/review-reliability`, references `commands/review/reliability.md`, or describes the same workflow intent.
...
- ../../../commands/review/reliability.md
