...
Use this skill when the user asks for `/review-scalability`, references `commands/review/scalability.md`, or describes the same workflow intent.
...
- ../../../commands/review/scalability.md
