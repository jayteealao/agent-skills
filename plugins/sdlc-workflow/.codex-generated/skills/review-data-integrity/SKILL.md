...
Use this skill when the user asks for `/review-data-integrity`, references `commands/review/data-integrity.md`, or describes the same workflow intent.
...
- ../../../commands/review/data-integrity.md
