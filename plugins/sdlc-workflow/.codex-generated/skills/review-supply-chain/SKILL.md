...
Use this skill when the user asks for `/review-supply-chain`, references `commands/review/supply-chain.md`, or describes the same workflow intent.
...
- ../../../commands/review/supply-chain.md
