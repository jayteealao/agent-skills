...
function validateFilename(filename) {
  ...
  // intake-mode hotfix/refactor mini-pipelines + wf-meta skip records use stable
  // prefix names rather than the NN convention (hf-brief.md, rf-plan.md, skip-shape.md).
