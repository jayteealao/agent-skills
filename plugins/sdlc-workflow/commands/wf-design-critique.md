...
Delegate each assessment to a separate sub-agent dispatched in parallel for independence. Sub-agents should return their findings as structured text. Do NOT output findings to the user yet.
