...
Do this in order:
1. Read the full workflow trail, especially verification, review, handoff, and ship outputs.
2. Identify what worked, what caused friction, and what should be codified.
3. Suggest concrete updates for AGENTS.md, CLAUDE.md, hooks, test coverage, CI checks, and command prompts.
