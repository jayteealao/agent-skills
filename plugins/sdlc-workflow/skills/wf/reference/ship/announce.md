...
- `${CLAUDE_PLUGIN_ROOT}/skills/wf/reference/docs/how-to.md`
- `${CLAUDE_PLUGIN_ROOT}/skills/wf/reference/docs/reference.md`
- `${CLAUDE_PLUGIN_ROOT}/skills/wf/reference/docs/tutorial.md`
- `${CLAUDE_PLUGIN_ROOT}/skills/wf/reference/docs/explanation.md`
- `${CLAUDE_PLUGIN_ROOT}/skills/wf/reference/docs/readme.md`
...
Use AskUserQuestion to ask about audience and delivery channel in a single call:
