...
- **Not an explainer** — if the user wants to know *how* something works, that is a plain research conversation outside `/wf`. `discover` answers "is my theory correct?", not "what is happening here?"
