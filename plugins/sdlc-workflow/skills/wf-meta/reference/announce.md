...
|----------|-------------|-------------------|
| `how-to` | Users announcement | Invoke `how-to-guide-writer` skill before drafting |
| `reference` | Engineering announcement | Invoke `reference-writer` skill before drafting |
| `tutorial` | Users announcement (major new capability only) | Invoke `tutorial-writer` skill before drafting |
| `explanation` | Engineering or Product announcement | Invoke `explanation-writer` skill before drafting |
| `readme-update` | All audiences (if scope changed significantly) | Invoke `readme-writer` skill before drafting |
