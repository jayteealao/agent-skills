...
**Purpose:** Document solved problems to build searchable project knowledge with category-based organization (enum-validated problem types).

## Overview

This skill captures problem solutions immediately after confirmation, creating structured documentation that serves as a searchable knowledge base for future sessions.

**Organization:** Single-file architecture - each problem documented as one markdown file in its symptom category directory (e.g., `.claude/solutions/performance-issues/n-plus-one-api-calls.md`). Files use YAML frontmatter for metadata and searchability.
...
- **Area**: Which part of the project had the problem
...
1. Which part of the project had this issue?
...
Format: `[sanitized-symptom]-[area]-[YYYYMMDD].md`
...
- `fk-constraint-violation-session-api-20260208.md`
- `serialization-mismatch-android-client-20260208.md`
- `wrangler-resolution-failure-workers-monorepo-20260208.md`
</step>
...
- severity: must be one of [critical, high, medium, low], got "urgent"
...
- Affects multiple areas or foundational infrastructure
- Non-obvious solution
...
2. Add to Critical Patterns - Promote to critical patterns list
...
- Foundational requirement (build system, API contracts, etc.)

Action:
1. Extract pattern from the documentation
2. Format as WRONG vs CORRECT with code examples
3. Add to `.claude/solutions/patterns/critical-patterns.md`
...
User selects this when the documented solution relates to an existing skill:
...
5. **Validate YAML:**
   ...
   root_cause: missing_optimization
   severity: high
   tags: [n-plus-one, eager-loading, performance]
   ```
   Valid
6. **Create documentation:**
   - `.claude/solutions/performance-issues/n-plus-one-api-layer-20260208.md`
