...
Use this template when adding a pattern to `.claude/solutions/patterns/critical-patterns.md`:
...
**Applies when:** [When this pattern is relevant]
...
6. Clarify when this pattern applies in "Applies when"
