...
**Examples:**
```
001-pending-p1-fix-fk-constraint.md
002-ready-p1-fix-serialization-error.md
005-complete-p2-refactor-gateway-routing.md
```
...
```bash
# Search by tag
grep -l "tags:.*typescript" .claude/todos/*.md

# Search by priority
ls .claude/todos/*-p1-*.md

# Full-text search
grep -r "serialization" .claude/todos/
```
