...
# 3. Plugin skills - check installed plugins
...
<thinking>
Check for documented learnings. These are solved problems stored as markdown files. Spawn a sub-agent for each learning to check if it's relevant.
</thinking>

**LEARNINGS LOCATION - Check these exact folders:**

```
.claude/solutions/           <-- PRIMARY: Project-level learnings
- performance-issues/
  - *.md
- debugging-patterns/
  - *.md
...
### 5. Discover and Run Review Agents

<thinking>
Dynamically discover available review agents and run them against the plan for comprehensive feedback.
</thinking>

**Step 1: Discover available agents from ALL sources**
...
# 3. Plugin agents - check all installed plugins
...
**Step 3: Launch relevant agents in parallel**

For agents that match the plan's domain, launch a Task in parallel:

```
Task [agent-name]: "Review this plan using your expertise. Apply all your checks and patterns. Plan content: [full plan content]"
```

**Recommended agents for plan review:**
- `code-simplicity-reviewer` - Check for unnecessary complexity
- `senior-code-reviewer` - Overall code quality
- `framework-conventions-reviewer` - Framework best practices
...
2. **Run `/workflows:plan-review`** - Get feedback from reviewers on enhanced plan
...
- **`/workflows:plan-review`** - Call the /workflows:plan-review command with the plan file path
