...
1. **Documentation Gathering**:
   - Search for and fetch official framework and library documentation
...
4. **Source Code Analysis**:
   - Use `bundle show <gem_name>` to locate installed gems (Ruby)
   - Use `npm ls` or check node_modules for JavaScript packages
...
1. **Initial Assessment**:
   ...
   - Determine the installed version from Gemfile.lock, package.json, or similar
   - Understand the specific feature or problem being addressed

2. **Documentation Collection**:
   - Search for official documentation using web search
   - Prioritize official sources over third-party tutorials
   - Collect multiple perspectives when official docs are unclear

3. **Source Exploration**:
   - Use appropriate package manager commands to find library locations
