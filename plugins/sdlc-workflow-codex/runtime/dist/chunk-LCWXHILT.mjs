...
import { basename, dirname, join as join2, sep } from "node:path";
...
function pruneRegistry() {
  ...
  for (const e of entries) {
    ...
    const present = valid && existsSync2(e.repoRoot) && existsSync2(e.viewDir) && (existsSync2(join2(e.viewDir, ".last-render")) || countPending(e.viewDir) > 0);
    if (present) {
      kept.push(e);
    } else {
      pruned++;
