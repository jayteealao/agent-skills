...
Before reviewing code, ask the user directly in chat:
...
Use your native file-editing tools + Git + shell commands:
```bash
# Get changed files
...
Create `.ai/reviews/<SESSION_SLUG>/reviews/review-architecture-{YYYY-MM-DD}.md`
...
**Reviewer:** Codex Architecture Review Agent
**Date:** {YYYY-MM-DD}
...
## Review Location
Saved to: `.ai/reviews/{SESSION_SLUG}/reviews/review-architecture-{YYYY-MM-DD}.md`
