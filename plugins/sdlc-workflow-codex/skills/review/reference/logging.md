...
Search for all logging patterns using file search and content search:
...
Create `.ai/workflows/<SESSION_SLUG>/reviews/review-logging-YYYY-MM-DD.md`:
...
## Report Location
Full report: `.ai/workflows/{SESSION_SLUG}/reviews/review-logging-{DATE}.md`
```
