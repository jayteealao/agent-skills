...
Create `.ai/reviews/<SESSION_SLUG>/reviews/review-testing-{YYYY-MM-DD}.md`
...
**Date:** {YYYY-MM-DD}
**Reviewer:** Codex Testing Review Agent
...
## Review Location
Saved to: `.ai/reviews/{SESSION_SLUG}/reviews/review-testing-{YYYY-MM-DD}.md`
