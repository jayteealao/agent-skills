...
**Search for data fields** using search/list files:
```bash
# Find form fields
...
Create `.ai/reviews/<SESSION_SLUG>/reviews/review-privacy-{YYYY-MM-DD}.md`
...
## Review Location
Saved to: `.ai/reviews/{SESSION_SLUG}/reviews/review-privacy-{YYYY-MM-DD}.md`
