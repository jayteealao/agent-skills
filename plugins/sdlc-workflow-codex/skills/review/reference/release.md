...
Use shell commands and search/list files:
```bash
# Check version files
...
Create `.ai/reviews/<SESSION_SLUG>/reviews/review-release-{YYYY-MM-DD}.md`
...
**Reviewer:** Codex Release Review Agent
**Date:** {YYYY-MM-DD}
...
## Review Location
Saved to: `.ai/reviews/{SESSION_SLUG}/reviews/review-release-{YYYY-MM-DD}.md`
