...
Use shell commands and file search:
```bash
...
Create `.ai/workflows/<SESSION_SLUG>/reviews/review-infra-{YYYY-MM-DD}.md`
...
**Reviewer:** Codex Infrastructure Review Agent
**Date:** {YYYY-MM-DD}
...
## Review Location
Saved to: `.ai/workflows/{SESSION_SLUG}/reviews/review-infra-{YYYY-MM-DD}.md`
