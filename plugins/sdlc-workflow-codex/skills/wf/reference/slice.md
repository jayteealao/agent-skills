...
1. **Discovery phase — ask about slicing strategy before cutting.**
   Interview the user in chat before you finalize slice boundaries. Ask only the questions this decomposition needs, batched into as few rounds as the dependency structure allows. Present options as a short numbered list.
