...
3. **Options state consequences, not just mechanisms.** Each numbered option
   says what choosing it means in outcome terms — effort, risk, maintenance
   burden, what becomes easier or harder later — not merely the name of the
   approach. Two options whose descriptions differ only in jargon are one
   option; go find the real tradeoff.
4. **State reversibility.** Say whether the choice is cheap to change later or
   ...
   framing, not buried in an option line.
...
**Where the words go (numbered chat list):** the framing sentences sit directly
above the numbered options; each option is one line of label + consequence.
