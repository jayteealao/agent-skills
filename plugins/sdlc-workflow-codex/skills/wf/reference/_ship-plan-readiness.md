...
Otherwise print the `drift-findings[]` as a short table (signal · detail · block to amend), then ask in chat and wait:

"The ship plan drifted from the repo (<N> finding(s)). Amend it before continuing?
