...
1. Amend the plan — STOP; run `$wf ship-plan edit` and amend block(s) <blocks>, then re-run.
2. Acknowledge and proceed — the drift is known/intentional. Record a reason and continue on the current plan.
