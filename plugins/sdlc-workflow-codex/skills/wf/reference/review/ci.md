...
Before reviewing pipelines, ask the user directly in chat:
...
Create `.ai/reviews/<SESSION_SLUG>/reviews/review-ci-{YYYY-MM-DD}.md`
...
**Reviewer:** Codex CI/CD Review Agent
**Date:** {YYYY-MM-DD}
...
## Review Location
Saved to: `.ai/reviews/{SESSION_SLUG}/reviews/review-ci-{YYYY-MM-DD}.md`
