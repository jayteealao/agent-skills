...
Create `.ai/reviews/<SESSION_SLUG>/reviews/review-reliability-<YYYY-MM-DD>.md` with findings.
...
Create `.ai/reviews/<SESSION_SLUG>/reviews/review-reliability-<YYYY-MM-DD>.md`:
...
**Scope:** <Description>
**Reviewer:** Codex Reliability Review Agent
**Date:** <YYYY-MM-DD>
...
## Review Location
Saved to: `.ai/reviews/<SESSION_SLUG>/reviews/review-reliability-<YYYY-MM-DD>.md`
