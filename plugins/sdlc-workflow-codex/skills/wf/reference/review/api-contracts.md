...
Before reviewing API contracts, ask the user directly in chat:
...
Create `.ai/reviews/<SESSION_SLUG>/reviews/review-api-contracts-<YYYY-MM-DD>.md` with findings categorized by:
- Breaking changes
- Versioning issues
...
Create `.ai/reviews/<SESSION_SLUG>/reviews/review-api-contracts-<YYYY-MM-DD>.md`:
...
**Reviewer:** Codex API Contracts Review Agent
**Date:** <YYYY-MM-DD>
...
## Review Location
Saved to: `.ai/reviews/<SESSION_SLUG>/reviews/review-api-contracts-<YYYY-MM-DD>.md`
