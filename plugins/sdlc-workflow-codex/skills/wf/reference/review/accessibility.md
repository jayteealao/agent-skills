...
Before reviewing accessibility, ask the user directly in chat:
...
Create `.ai/reviews/<SESSION_SLUG>/reviews/review-accessibility-<YYYY-MM-DD>.md` with:
...
Create `.ai/reviews/<SESSION_SLUG>/reviews/review-accessibility-<YYYY-MM-DD>.md`:
...
**Reviewer:** Codex Accessibility Review Agent
**Date:** <YYYY-MM-DD>
...
## Review Location
Saved to: `.ai/reviews/<SESSION_SLUG>/reviews/review-accessibility-<YYYY-MM-DD>.md`
