...
Create `.ai/reviews/<SESSION_SLUG>/reviews/review-supply-chain-{YYYY-MM-DD}.md`
...
**Date:** {YYYY-MM-DD}
**Reviewer:** Codex Supply Chain Review Agent
...
## Review Location
Saved to: `.ai/reviews/{SESSION_SLUG}/reviews/review-supply-chain-{YYYY-MM-DD}.md`
