...
- Internal context includes workflow artifact paths (`.ai/workflows/...`, `.codex/...`, `.ai/dep-updates/...`), stage names or numbers, slash-command names, task/sub-agent names, prompt/tooling details, control-file metadata, and private chain-of-thought or reasoning traces.
...
If SCOPE is `pr` and TARGET is not provided, ask the user directly in chat for the PR URL.

## Step 2: Find all user-facing text

Use shell commands and search/list files to find UI component files:
...
Create `.ai/reviews/<SESSION_SLUG>/reviews/review-ux-copy-<YYYY-MM-DD>.md` with:
...
Add the review artifact to `.ai/reviews/<SESSION_SLUG>/README.md`.
...
Create `.ai/reviews/<SESSION_SLUG>/reviews/review-ux-copy-<YYYY-MM-DD>.md`:
...
**Reviewer:** Codex UX Copy Review Agent
**Date:** <YYYY-MM-DD>
...
## Review Location
Saved to: `.ai/reviews/<SESSION_SLUG>/reviews/review-ux-copy-<YYYY-MM-DD>.md`
