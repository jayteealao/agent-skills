...
Before reviewing cost implications, ask the user directly in chat:
...
Create `.ai/reviews/<SESSION_SLUG>/reviews/review-cost-<YYYY-MM-DD>.md` with:
...
Create `.ai/reviews/<SESSION_SLUG>/reviews/review-cost-<YYYY-MM-DD>.md`:
...
**Reviewer:** Codex Cost Review Agent
**Date:** <YYYY-MM-DD>
...
## Review Location
Saved to: `.ai/reviews/<SESSION_SLUG>/reviews/review-cost-<YYYY-MM-DD>.md`
