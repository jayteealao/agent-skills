...
Before reviewing data integrity, ask the user directly in chat:
...
Create `.ai/reviews/<SESSION_SLUG>/reviews/review-data-integrity-<YYYY-MM-DD>.md` with findings.
...
Create `.ai/reviews/<SESSION_SLUG>/reviews/review-data-integrity-<YYYY-MM-DD>.md`:
...
**Scope:** <Description>
**Reviewer:** Codex Data Integrity Review Agent
**Date:** <YYYY-MM-DD>
...
## Review Location
Saved to: `.ai/reviews/<SESSION_SLUG>/reviews/review-data-integrity-<YYYY-MM-DD>.md`
