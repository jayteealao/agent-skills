...
Create `.ai/workflows/<SESSION_SLUG>/reviews/review-migrations-<YYYY-MM-DD>.md` with findings.

## Step 8: Update session README

Update `.ai/workflows/<SESSION_SLUG>/README.md` to add the review link.

# OUTPUT FORMAT

Create `.ai/workflows/<SESSION_SLUG>/reviews/review-migrations-<YYYY-MM-DD>.md`:
...
**Scope:** <Description>
**Reviewer:** Codex Database Migration Review Agent
**Date:** <YYYY-MM-DD>
...
## Review Location
Saved to: `.ai/workflows/<SESSION_SLUG>/reviews/review-migrations-<YYYY-MM-DD>.md`
