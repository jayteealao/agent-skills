...
Search codebase for observability instrumentation using shell commands or your native file-editing tools:
...
Create `.ai/workflows/<SESSION_SLUG>/reviews/review-observability-YYYY-MM-DD.md`:
...
## Report Location
Full report: `.ai/workflows/{SESSION_SLUG}/reviews/review-observability-{DATE}.md`
