...
Use a different reference in this skill when the request is specifically for:

- a step-by-step lesson, use [tutorial.md](tutorial.md)
- a task guide, use [how-to.md](how-to.md)
- API or CLI details, use [reference.md](reference.md)
- conceptual background, use [explanation.md](explanation.md)
