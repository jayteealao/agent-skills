...
**This stub does no work** — it exists only to tell you the new skill:

| Old `$wf-docs …` | New skill |
|---|---|
...
Tell the user the corrected skill and STOP. Do not attempt to generate docs from this stub.
